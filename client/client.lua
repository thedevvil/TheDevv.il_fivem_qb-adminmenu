...
local menu_button = menu:AddButton({
    ...
    value = menu2,
    description = 'Yönetici Ayarları'
})
local menu_button2 = menu:AddButton({
    icon = '🙍‍♂️',
    label = 'Oyuncu Ayarları',
    value = menu4,
    description = 'Oyuncu listesini görüntüle'
})
...
menu_button11:On("select",function()
    ...
    local elements = {
        ...
        [2] = {
            ...
            label = 'Harika gün',
            value = "Harika Gün",
            description = 'Harika gün'
        },
        [3] = {
            icon = '☀️',
            label = 'Normal Hava',
            value = "Normal Hava",
            description = 'Normal Hava!'
        },
        [4] = {
            icon = '🌁',
            label = 'Sis',
            value = "Sis",
            description = 'Sisli hava!'
        },
        [5] = {
            icon = '🌫️',
            label = 'Ekstra Sis',
            value = "Ekstra Sis",
            description = 'Sisli Hava x2!'
        },
        [6] = {
            icon = '⛅',
            label = 'Güneşli',
        ...
        [7] = {
            ...
            label = 'Bulutlu Hava',
            value = "Bulutlu Hava",
            description = 'Hava Bugün yağacak gibi?'
        },
        [8] = {
            icon = '🌤️',
            label = 'Clearing',
            value = "CLEARING",
            description = 'Bulutlerı temizledin!'
        },
        [9] = {
            icon = '☂️',
            label = 'Yağmur',
            value = "Yağmur",
            description = 'Yağmur yağdır!'
        },
        ...
        [10] = {
            ...
            label = 'Şimşekli hava',
            value = "Şimşekli hava",
            description = 'Koş ve saklan!'
        },
        [11] = {
            icon = '❄️',
            label = 'Karlı hava',
            value = "Karlı hava",
            description = 'Kar Yağmaya başladı'
        },
        [12] = {
            icon = '🌨️',
            label = 'Karlı hava x2',
            value = "Karlı hava x2",
            description = 'Kar Fırtınası?'
        },
        [13] = {
            icon = '❄️',
            label = 'Light Snow',
        ...
        [14] = {
            icon = '🌨️',
            label = 'Kar Fırtınası (XMAS)',
            value = "Kar Fırtınası",
            description = 'Kar topu savaşı!'
        },
        [15] = {
            icon = '🎃',
            label = 'Cadılar Bayramı',
            value = "Cadılar Bayramı",
            description = 'Şekermi şakamı?!'
        }
    }
...
local menu_button69 = menu:AddButton({
    icon = '🔧',
    label = 'Developer Ayarları',
    value = menu11,
    description = 'Dev Ayarları'
})
local coords3_button = menu11:AddButton({
    icon = '📋',
    label = 'kopyala vector3',
    value = 'Cordinatlar',
    description = 'Panoya Kopyala'
})
local coords4_button = menu11:AddButton({
    icon = '📋',
    label = 'Copyala vector4',
    value = 'Cordinatlar',
    description = 'Panoya Kopyala'
})
local togglecoords_button = menu11:AddCheckbox({
    ...
    label = 'Cordinatlar',
    value = nil,
    description = 'Ekranda kordinatları göster'
})

local heading_button = menu11:AddButton({
    icon = '📋',
    label = ' Heading Kopyala',
    value = 'heading',
    description = 'Başlığı panoya kopyala'
})
...
local menu12_button1 = menu12:AddButton({
    ...
    label = 'Araç çıkar',
    value = menu13,
    description = 'bir araç çıkardın'
})
local menu12_button2 = menu12:AddButton({
    icon = '🔧',
    label = 'Aracı Tamir et',
    value = 'Tamir',
    description = 'aracı tamir ettin'
})
local menu12_button3 = menu12:AddButton({
    icon = '💲',
    label = 'Satın Al',
    value = 'Satın Al',
    description = 'Aracı ücretsiz satın aldın'
})
...
local function CopyToClipboard(dataType)
    ...
    elseif dataType == 'discord' then
        QBCore.Functions.Notify("Kişinin discord id'si kopyalandı!", "success")
    end
end
...
RegisterNetEvent('qb-admin:client:discordal', function(discord)
    SendNUIMessage({
        string = discord
    })
...
local function OpenPlayerMenus(player)
    ...
    local elements = {
        ...
        [13] = {
            ...
            value = "discord",
            description = "Kişinin discord idsini kopyala"
        }
    }
    for k, v in ipairs(elements) do
        local menu_button10 = Players:AddButton({
            ...
            description = v.description,
            select = function(btn)
                if v.value == "discord" then
                    TriggerServerEvent('qb-admin:server:discordal', player.id)
                end
                local values = btn.Value
